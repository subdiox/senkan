...
public class XmlStreamReader extends Reader {
    ...
    private static final ByteOrderMark[] XML_GUESS_BYTES = new ByteOrderMark[]{new ByteOrderMark("UTF-8", 60, 63, 120, 109), new ByteOrderMark(UTF_16BE, 0, 60, 0, 63), new ByteOrderMark(UTF_16LE, 60, 0, 63, 0), new ByteOrderMark(EBCDIC, 76, 111, 167, 148)};
    ...
    private String doLenientDetection(String httpContentType, XmlStreamReaderException ex) throws IOException {
        ...
        if (calculateHttpEncoding == null) {
            calculateHttpEncoding = this.defaultEncoding == null ? "UTF-8" : this.defaultEncoding;
        }
        return calculateHttpEncoding;
    }
