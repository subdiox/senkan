...
public interface AddressListParserTreeConstants {
    ...
    public static final String[] jjtNodeName = new String[]{"void", "address_list", "address", "mailbox", "name_addr", "group_body", "angle_addr", "route", "phrase", "addr_spec", "local_part", "domain"};
}
