...
public class DateTimeParserTokenManager implements DateTimeParserConstants {
    ...
    public static final String[] jjstrLiteralImages = new String[]{"", "\r", IOUtils.LINE_SEPARATOR_UNIX, ",", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", ":", null, "UT", "GMT", "EST", "EDT", "CST", "CDT", "MST", "MDT", "PST", "PDT", null, null, null, null, null, null, null, null, null, null, null, null, null, null};
    ...
    private final int jjMoveStringLiteralDfa0_0() {
        switch (this.curChar) {
            ...
            case 'O':
                return jjMoveStringLiteralDfa1_0(FileUtils.ONE_MB);
            case Endpoint.HTTP_PORT /*80*/:
    ...
    private final int jjMoveStringLiteralDfa1_0(long active0) {
        try {
            ...
            switch (this.curChar) {
                ...
                case 'c':
                    return jjMoveStringLiteralDfa2_0(active0, FileUtils.ONE_MB);
    ...
    private final int jjMoveStringLiteralDfa2_0(long old0, long active0) {
        ...
        try {
            ...
            switch (this.curChar) {
                case 'T':
                    if ((67108864 & active0) != 0) {
                        return jjStopAtPos(2, 26);
                    }
                    if ((134217728 & active0) != 0) {
                        return jjStopAtPos(2, 27);
                    }
                    if ((268435456 & active0) != 0) {
                        return jjStopAtPos(2, 28);
                    }
                    if ((536870912 & active0) != 0) {
                        return jjStopAtPos(2, 29);
                    }
                    if ((FileUtils.ONE_GB & active0) != 0) {
                        return jjStopAtPos(2, 30);
                    }
                    if ((2147483648L & active0) != 0) {
                        return jjStopAtPos(2, 31);
                    }
                    if ((4294967296L & active0) != 0) {
