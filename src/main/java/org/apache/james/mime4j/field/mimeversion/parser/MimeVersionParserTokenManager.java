...
public class MimeVersionParserTokenManager implements MimeVersionParserConstants {
    ...
    public static final int[] jjnewLexState = new int[]{-1, -1, -1, -1, 1, 0, -1, 2, -1, -1, -1, -1, -1, 3, -1, -1, 0, -1, -1, -1, -1};
    static final int[] jjnextStates = new int[0];
    public static final String[] jjstrLiteralImages = new String[]{"", "\r", IOUtils.LINE_SEPARATOR_UNIX, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, ".", null, null};
    static final long[] jjtoMore = new long[]{65488};
    static final long[] jjtoSkip = new long[]{40};
    static final long[] jjtoSpecial = new long[]{8};
    static final long[] jjtoToken = new long[]{458759};
