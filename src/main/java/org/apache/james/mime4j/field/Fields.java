...
public class Fields {
    ...
    public static UnstructuredField subject(String subject) {
        return (UnstructuredField) parse(UnstructuredField.PARSER, FieldName.SUBJECT, EncoderUtil.encodeIfNecessary(subject, Usage.TEXT_TOKEN, FieldName.SUBJECT.length() + 2));
    }
