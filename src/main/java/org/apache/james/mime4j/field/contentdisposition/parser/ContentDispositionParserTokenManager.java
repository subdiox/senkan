...
public class ContentDispositionParserTokenManager implements ContentDispositionParserConstants {
    ...
    static final long[] jjtoMore = new long[]{261952};
    static final long[] jjtoSkip = new long[]{160};
    static final long[] jjtoSpecial = new long[]{32};
    static final long[] jjtoToken = new long[]{1835039};
