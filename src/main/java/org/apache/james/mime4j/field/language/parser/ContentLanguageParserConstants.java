...
public interface ContentLanguageParserConstants {
    ...
    public static final String[] tokenImage = new String[]{"<EOF>", "\",\"", "\"-\"", "<WS>", "\"(\"", "\")\"", "<token of kind 6>", "\"(\"", "<token of kind 8>", "<token of kind 9>", "\"(\"", "\")\"", "<token of kind 12>", "\"\\\"\"", "<token of kind 14>", "<token of kind 15>", "\"\\\"\"", "<DIGITS>", "<ALPHA>", "<ALPHANUM>", "\".\"", "<QUOTEDPAIR>", "<ANY>"};
}
