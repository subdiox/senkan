...
public class ContentDispositionField extends AbstractField {
    ...
    private Date parseDate(String paramName) {
        ...
        if (value != null) {
            try {
                date = new DateTimeParser(new StringReader(value)).parseAll().getDate();
    ...
    private void parse() {
        ...
        if (dispositionType != null) {
            ...
            if (!(paramNames == null || paramValues == null)) {
                ...
                for (int i = 0; i < len; i++) {
                    this.parameters.put(((String) paramNames.get(i)).toLowerCase(Locale.US), (String) paramValues.get(i));
                }
            }
        }
        this.parsed = true;
