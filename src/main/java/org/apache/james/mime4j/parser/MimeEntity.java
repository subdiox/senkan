...
public class MimeEntity extends AbstractEntity {
    ...
    private EntityStateMachine nextMessage() {
        ...
        EntityStateMachine message = new MimeEntity(this.lineSource, new BufferedLineReaderInputStream(instream, 4096, this.config.getMaxLineLen()), this.body, 0, 1, this.config);
