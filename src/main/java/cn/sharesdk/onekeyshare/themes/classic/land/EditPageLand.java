...
public class EditPageLand extends EditPage implements OnClickListener, TextWatcher, Runnable {
    ...
    public void onCreate() {
        super.onCreate();
        float ratio = ((float) R.getScreenHeight(this.activity)) / 720.0f;
        ...
        this.llPage.addView(this.rlTitle, new LayoutParams(-1, (int) (70.0f * ratio)));
    ...
    private void initBody(RelativeLayout rlBody, float ratio) {
        ...
        lp = new LayoutParams(thumbWidth, thumbWidth);
