...
public class NetworkHelper {
    ...
    private HttpURLConnection getConnection(String urlStr, NetworkTimeOut timeout) throws Throwable {
        ...
        int readTimout = timeout == null ? readTimout : timeout.readTimout;
        if (readTimout > 0) {
    ...
    L_0x0171:
        r28 = new com.mob.tools.network.HttpConnectionImpl;	 Catch:{ Throwable -> 0x01c3 }
        r0 = r28;
        r0.<init>(r12);	 Catch:{ Throwable -> 0x01c3 }
        r0 = r40;
        r1 = r28;
        r0.onResponse(r1);	 Catch:{ Throwable -> 0x01c3 }
    ...
    public String downloadCache(Context context, String url, String cacheFolder, boolean skipIfCached, NetworkTimeOut timeout) throws Throwable {
        ...
        if (skipIfCached) {
            cache = new File(R.getCachePath(context, cacheFolder), Data.MD5(url));
        ...
        if (status == 200) {
            ...
            cache = new File(R.getCachePath(context, cacheFolder), name);
            if (skipIfCached && cache.exists()) {
                conn.disconnect();
                MobLog.getInstance().i("use time: " + (System.currentTimeMillis() - time), new Object[0]);
                return cache.getAbsolutePath();
            ...
            errMap.put(GCMConstants.EXTRA_ERROR, sb.toString());
    ...
    L_0x00d4:
        r16 = new com.mob.tools.network.HttpConnectionImpl23;	 Catch:{ Throwable -> 0x010e }
        r0 = r16;
        r0.<init>(r5);	 Catch:{ Throwable -> 0x010e }
        r0 = r25;
        r1 = r16;
        r0.onResponse(r1);	 Catch:{ Throwable -> 0x010e }
        r5.disconnect();
    L_0x00e5:
        r16 = com.mob.tools.MobLog.getInstance();
        r17 = new java.lang.StringBuilder;
    ...
    L_0x00ef:
        r16 = new com.mob.tools.network.HttpConnectionImpl23;	 Catch:{ Throwable -> 0x0129 }
        r0 = r16;
        r0.<init>(r5);	 Catch:{ Throwable -> 0x0129 }
        r0 = r28;
        r1 = r16;
        r0.onResponse(r1);	 Catch:{ Throwable -> 0x0129 }
        r5.disconnect();
    L_0x0100:
        r16 = com.mob.tools.MobLog.getInstance();
        r17 = new java.lang.StringBuilder;
    ...
    L_0x00b5:
        r13 = new com.mob.tools.network.HttpConnectionImpl23;	 Catch:{ Throwable -> 0x00f3 }
        r13.<init>(r5);	 Catch:{ Throwable -> 0x00f3 }
        r0 = r26;
        r0.onResponse(r13);	 Catch:{ Throwable -> 0x00f3 }
        r5.disconnect();
    L_0x00c2:
        r13 = com.mob.tools.MobLog.getInstance();
        r16 = new java.lang.StringBuilder;
    ...
    public void rawGet(java.lang.String r10, com.mob.tools.network.HttpResponseCallback r11, com.mob.tools.network.NetworkHelper.NetworkTimeOut r12) throws java.lang.Throwable {
        ...
        r4 = com.mob.tools.MobLog.getInstance();
        ...
        r4.i(r5, r6);
        r0 = r9.getConnection(r10, r12);
        r0.connect();
        if (r11 == 0) goto L_0x005e;
    L_0x002a:
        r4 = new com.mob.tools.network.HttpConnectionImpl23;	 Catch:{ Throwable -> 0x0057 }
        r4.<init>(r0);	 Catch:{ Throwable -> 0x0057 }
        r11.onResponse(r4);	 Catch:{ Throwable -> 0x0057 }
        r0.disconnect();
    L_0x0035:
        r4 = com.mob.tools.MobLog.getInstance();
        r5 = new java.lang.StringBuilder;
    ...
    L_0x007f:
        r14 = new com.mob.tools.network.HttpConnectionImpl23;	 Catch:{ Throwable -> 0x00b5 }
        r14.<init>(r5);	 Catch:{ Throwable -> 0x00b5 }
        r0 = r22;
        r0.onResponse(r14);	 Catch:{ Throwable -> 0x00b5 }
        r5.disconnect();
    L_0x008c:
        r14 = com.mob.tools.MobLog.getInstance();
        r15 = new java.lang.StringBuilder;
    ...
    L_0x00a0:
        ...
        r0 = r30;
        r0.onResponse(r10);	 Catch:{ Throwable -> 0x00de }
        if (r10 == 0) goto L_0x00ae;
    L_0x00ab:
        r10.close();	 Catch:{ Throwable -> 0x015e }
    L_0x00ae:
        r6.disconnect();
    L_0x00b1:
        r21 = com.mob.tools.MobLog.getInstance();
