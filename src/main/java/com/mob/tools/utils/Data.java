...
public class Data {
    ...
    public static String AES128Decode(String key, byte[] cipherText) throws Throwable {
        return (key == null || cipherText == null) ? null : new String(AES128Decode(key.getBytes("UTF-8"), cipherText), "UTF-8");
    }
    ...
    public static byte[] AES128Encode(byte[] key, String text) throws Throwable {
        return (key == null || text == null) ? null : AES128Encode(key, text.getBytes("UTF-8"));
    }
    ...
    public static String Base64AES(String msg, String key) {
        ...
        try {
            ...
            return (TextUtils.isEmpty(result) || !result.contains(IOUtils.LINE_SEPARATOR_UNIX)) ? result : result.replace(IOUtils.LINE_SEPARATOR_UNIX, "");
        } catch (Throwable e) {
    ...
    public static String MD5(File data) {
        ...
        try {
            ...
            byte[] md5 = rawMD5(fis);
            fis.close();
            return md5 != null ? toHex(md5) : null;
        } catch (Throwable e) {
            MobLog.getInstance().w(e);
            return null;
        }
    ...
    public static String MD5(String data) {
        ...
        return tmp != null ? toHex(tmp) : null;
    }
    ...
    public static byte[] SHA1(String text) throws Throwable {
        return TextUtils.isEmpty(text) ? null : SHA1(text.getBytes("utf-8"));
    }
    ...
    public static byte[] rawRSADecode(byte[] data, byte[] privateKey, int keySize) throws Throwable {
        ...
        RSAPrivateKey key = (RSAPrivateKey) KeyFactory.getInstance("RSA").generatePrivate(new PKCS8EncodedKeySpec(privateKey));
    ...
    public static byte[] rawRSAEncode(byte[] data, byte[] publicKey, int keySize) throws Throwable {
        ...
        RSAPublicKey key = (RSAPublicKey) KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(publicKey));
        Cipher cipher = Cipher.getInstance("RSA/None/PKCS1Padding");
        cipher.init(1, key);
