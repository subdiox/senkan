...
public final class NakamapBroadcastManager {
    private static final boolean DEBUG = false;
    static final int MSG_EXEC_PENDING_BROADCASTS = 1;
    private static final String TAG = "NakamapBroadcastManager";
    private static NakamapBroadcastManager mInstance;
    ...
    public static NakamapBroadcastManager getInstance(Context context) {
        NakamapBroadcastManager nakamapBroadcastManager;
        synchronized (mLock) {
            if (mInstance == null) {
                mInstance = new NakamapBroadcastManager(context.getApplicationContext());
            }
            nakamapBroadcastManager = mInstance;
        }
        return nakamapBroadcastManager;
    }

    private NakamapBroadcastManager(Context context) {
        this.mAppContext = context;
        this.mHandler = new Handler(context.getMainLooper()) {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 1:
                        NakamapBroadcastManager.this.executePendingBroadcasts();
                        return;
                    default:
    ...
    L_0x002e:
        ...
        com.kayac.lobi.libnakamap.utils.Log.v(r1, r7);	 Catch:{ all -> 0x010b }
    L_0x0062:
        r0 = r17;
    ...
    L_0x0096:
        ...
        r13 = (com.kayac.lobi.libnakamap.utils.NakamapBroadcastManager.ReceiverRecord) r13;	 Catch:{ all -> 0x010b }
    ...
    L_0x0145:
        ...
        r1 = (com.kayac.lobi.libnakamap.utils.NakamapBroadcastManager.ReceiverRecord) r1;	 Catch:{ all -> 0x010b }
        r7 = 0;
    ...
    L_0x0151:
        ...
        r7 = new com.kayac.lobi.libnakamap.utils.NakamapBroadcastManager$BroadcastRecord;	 Catch:{ all -> 0x010b }
        r0 = r18;
    ...
    L_0x0175:
        ...
        goto L_0x0174;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kayac.lobi.libnakamap.utils.NakamapBroadcastManager.sendBroadcast(android.content.Intent):boolean");
    }
    ...
    L_0x000c:
        ...
        return;
    L_0x000e:
        r2 = new com.kayac.lobi.libnakamap.utils.NakamapBroadcastManager.BroadcastRecord[r0];	 Catch:{ all -> 0x003e }
        r5 = r8.mPendingBroadcasts;	 Catch:{ all -> 0x003e }
    ...
    L_0x002a:
        r5 = r1.receivers;
        r5 = r5.get(r4);
        r5 = (com.kayac.lobi.libnakamap.utils.NakamapBroadcastManager.ReceiverRecord) r5;
        r5 = r5.receiver;
        r6 = r8.mAppContext;
        r7 = r1.intent;
        r5.onReceive(r6, r7);
    ...
    L_0x0041:
        ...
        goto L_0x001c;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kayac.lobi.libnakamap.utils.NakamapBroadcastManager.executePendingBroadcasts():void");
    }
}
