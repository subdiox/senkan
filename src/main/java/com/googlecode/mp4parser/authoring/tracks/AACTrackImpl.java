...
public class AACTrackImpl extends AbstractTrack {
    ...
    static {
        ...
        samplingFrequencyIndexMap.put(Integer.valueOf(MicInput.SAMPLE_RATE), Integer.valueOf(4));
        ...
        samplingFrequencyIndexMap.put(Integer.valueOf(4), Integer.valueOf(MicInput.SAMPLE_RATE));
