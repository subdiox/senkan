...
public class DownloadService extends Service {
    ...
    private void setUpNotification(String notification) {
        this.mBuilder = new Builder(this.mContext).setSmallIcon(R.drawable.app_banner).setContentText("").setContentTitle(notification).setOngoing(true).setProgress(100, 0, false);
