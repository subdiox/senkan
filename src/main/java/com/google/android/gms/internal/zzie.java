...
public final class zzie implements zzhx {
    ...
    public static class zza {
        ...
        public Intent zza(Context context, Map<String, String> map) {
            ...
            Uri build = Endpoint.SCHEME_HTTP.equalsIgnoreCase(parse.getScheme()) ? parse.buildUpon().scheme("https").build() : "https".equalsIgnoreCase(parse.getScheme()) ? parse.buildUpon().scheme(Endpoint.SCHEME_HTTP).build() : null;
    ...
    public void zza(zzqp com_google_android_gms_internal_zzqp, Map<String, String> map) {
        String str = (String) map.get(ChatListUtil.SUFFIX_ADS);
        if (str == null) {
            ...
            if ("expand".equalsIgnoreCase(str)) {
                ...
                zzr(true);
                str = (String) map.get("u");
                zzkV.zza(new zzc((String) map.get(PushNotificationValue.INVITED), !TextUtils.isEmpty(str) ? zzv.zzcJ().zza(com_google_android_gms_internal_zzqp, str) : str, (String) map.get("m"), (String) map.get("p"), (String) map.get("c"), (String) map.get("f"), (String) map.get("e")));
            }
        } else {
