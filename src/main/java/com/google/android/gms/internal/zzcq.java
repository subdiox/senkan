...
public class zzcq implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    void zza(zzcu com_google_android_gms_internal_zzcu, Map<String, String> map) {
        ...
        zzpe.zzbc(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
    ...
    protected JSONObject zzd(@Nullable View view) throws JSONException {
        ...
        zzdI.put("windowVisibility", view.getWindowVisibility()).put("isAttachedToWindow", isAttachedToWindow).put("viewBox", new JSONObject().put(GetRanking.ORIGIN_TOP, zza(rect2.top, displayMetrics)).put("bottom", zza(rect2.bottom, displayMetrics)).put("left", zza(rect2.left, displayMetrics)).put("right", zza(rect2.right, displayMetrics))).put("adBox", new JSONObject().put(GetRanking.ORIGIN_TOP, zza(rect.top, displayMetrics)).put("bottom", zza(rect.bottom, displayMetrics)).put("left", zza(rect.left, displayMetrics)).put("right", zza(rect.right, displayMetrics))).put("globalVisibleBox", new JSONObject().put(GetRanking.ORIGIN_TOP, zza(rect3.top, displayMetrics)).put("bottom", zza(rect3.bottom, displayMetrics)).put("left", zza(rect3.left, displayMetrics)).put("right", zza(rect3.right, displayMetrics))).put("globalVisibleBoxVisible", globalVisibleRect).put("localVisibleBox", new JSONObject().put(GetRanking.ORIGIN_TOP, zza(rect4.top, displayMetrics)).put("bottom", zza(rect4.bottom, displayMetrics)).put("left", zza(rect4.left, displayMetrics)).put("right", zza(rect4.right, displayMetrics))).put("localVisibleBoxVisible", localVisibleRect).put("hitBox", new JSONObject().put(GetRanking.ORIGIN_TOP, zza(rect5.top, displayMetrics)).put("bottom", zza(rect5.bottom, displayMetrics)).put("left", zza(rect5.left, displayMetrics)).put("right", zza(rect5.right, displayMetrics))).put("screenDensity", (double) displayMetrics.density).put("isVisible", zzv.zzcJ().zza(view, this.zzwg, this.zzwh));
        return zzdI;
    }
    ...
    L_0x0076:
        ...
        com.google.android.gms.internal.zzpe.zza(r1, r0);	 Catch:{ all -> 0x0041 }
        goto L_0x006d;
    L_0x007c:
        r0 = move-exception;
        goto L_0x0076;
