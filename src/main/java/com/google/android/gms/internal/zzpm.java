...
public class zzpm {
    ...
    protected String zzn(Context context, final String str) {
        ...
        zzqf zza = new zzpp(context).zza(str, new zza<String>(this) {
            ...
            public String zzi(InputStream inputStream) {
                ...
                try {
                    ...
                    zzpe.zzc(str.length() != 0 ? str3.concat(str) : new String(str3), th);
                    return null;
                }
            }
        ...
        try {
            ...
            zzpe.zzb(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2), th);
            zza.cancel(true);
        } catch (Throwable e2) {
            th = e2;
            ...
            valueOf = String.valueOf(str);
            zzpe.zzb(valueOf.length() != 0 ? str3.concat(valueOf) : new String(str3), th);
        }
        return null;
    }
}
