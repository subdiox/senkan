...
public interface zzbhw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbhw {

        private static class zza implements zzbhw {
        ...
        public static zzbhw zzfn(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbhw)) ? new zza(iBinder) : (zzbhw) queryLocalInterface;
        }
