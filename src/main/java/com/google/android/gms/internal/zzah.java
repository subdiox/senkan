...
public enum zzah {
    ...
    COMPANY(AuthorizedAppValue.JSON_KEY_COMPANY),
    COMPONENT("component"),
    ...
    LOCALE("locale"),
    LOCATION(GroupStreamValue.LOCATION),
    ...
    TITLE(LoginEntranceDialog.ARGUMENTS_TITLE),
    ...
    TRACKING_ID(LoginEntranceDialog.ARGUMENTS_TRACKING_ID),
