...
public class zzgf {
    ...
    public boolean zza(@Nullable zzgd com_google_android_gms_internal_zzgd, String... strArr) {
    ...
    public void zzc(@Nullable zzgf com_google_android_gms_internal_zzgf) {
        synchronized (this.zzrN) {
        ...
        synchronized (this.zzrN) {
            for (zzgd com_google_android_gms_internal_zzgd : this.zzFr) {
                ...
                if (com_google_android_gms_internal_zzgd2 != null && time > 0) {
                    stringBuilder2.append(zzft).append(FilenameUtils.EXTENSION_SEPARATOR).append(time - com_google_android_gms_internal_zzgd2.getTime()).append(',');
                }
            }
            this.zzFr.clear();
