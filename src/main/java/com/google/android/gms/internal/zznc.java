...
public final class zznc {
    ...
    private void zzM(Map<String, List<String>> map) {
        ...
        try {
            ...
            zzpe.zzc("Error parsing configuration JSON", e);
            this.zzTK = new zzmm();
        }
    }
    ...
    private void zzO(Map<String, List<String>> map) {
        ...
        if (!TextUtils.isEmpty(zzc)) {
            try {
                ...
                zzpe.zzc("Error parsing safe browsing header", e);
            }
        }
    }
    ...
    static long zzd(Map<String, List<String>> map, String str) {
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            try {
                ...
                zzpe.zzbe(new StringBuilder((String.valueOf(str).length() + 36) + String.valueOf(str2).length()).append("Could not parse float from ").append(str).append(" header: ").append(str2).toString());
            }
        }
        return -1;
    }
