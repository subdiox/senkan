    ...
    private void zzkv() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new OnClickListener(this) {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    zzv.zzcJ().zzb(this.zzXg.mContext, Intent.createChooser(new Intent("android.intent.action.SEND").setType(ContentTypeField.TYPE_TEXT_PLAIN).putExtra("android.intent.extra.TEXT", zzaZ), "Share via"));
                }
            });
