...
public class zzpi {
    ...
    public void zza(final Context context, @Nullable final String str, String str2, Bundle bundle, boolean z) {
        if (z) {
            bundle.putString(URLCons.DEVICE, zzv.zzcJ().zzkm());
            ...
            com_google_android_gms_internal_zzgl.zza(new com.google.android.gms.internal.zzgl.zza(this) {
                public void zzfE() {
                    for (String str : list) {
                        ...
                        zzpe.zzbd(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
                        com_google_android_gms_internal_zzgl.mayLaunchUrl(Uri.parse(str), null, null);
                    }
                    com_google_android_gms_internal_zzgl.zzd((Activity) context);
                }
                    ...
                    if (zzeh.zzeO().zzkJ()) {
                        ...
                        while (this.zzHY == null) {
                            try {
                                ...
                                zzpe.zzbe(str2.length() != 0 ? str3.concat(str2) : new String(str3));
                            }
                        }
                    }
                }
    ...
    public boolean zzy(Context context) {
        ...
        if ((resolveActivity.activityInfo.configChanges & 16) == 0) {
            zzpe.zzbe(String.format(str, new Object[]{"keyboard"}));
            z = false;
        } else {
            z = true;
        }
        if ((resolveActivity.activityInfo.configChanges & 32) == 0) {
            zzpe.zzbe(String.format(str, new Object[]{"keyboardHidden"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 128) == 0) {
            zzpe.zzbe(String.format(str, new Object[]{"orientation"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 256) == 0) {
            zzpe.zzbe(String.format(str, new Object[]{"screenLayout"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 512) == 0) {
            zzpe.zzbe(String.format(str, new Object[]{"uiMode"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 1024) == 0) {
            zzpe.zzbe(String.format(str, new Object[]{"screenSize"}));
            z = false;
        }
        if ((resolveActivity.activityInfo.configChanges & 2048) != 0) {
            return z;
        }
        zzpe.zzbe(String.format(str, new Object[]{"smallestScreenSize"}));
        return false;
    }
