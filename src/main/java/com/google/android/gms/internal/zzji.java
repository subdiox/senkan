...
import com.kayac.lobi.libnakamap.net.APIDef.PostGroupChat;
...
public final class zzji {
    ...
    public zzji(JSONObject jSONObject) throws JSONException {
        ...
        JSONObject optJSONObject = jSONObject.optJSONObject(Host.AD);
        this.zzJG = optJSONObject != null ? optJSONObject.toString() : null;
        JSONObject optJSONObject2 = jSONObject.optJSONObject(RequestKey.DATA);
        ...
        optJSONObject = jSONObject.optJSONObject(PostGroupChat.RequestKey.OPTION_ASSETS);
