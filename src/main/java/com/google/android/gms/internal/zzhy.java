    ...
    public JSONObject zzaa(String str) {
        try {
            ...
            try {
                ...
                if (zza.isSuccess()) {
                    jSONObject2.put(Cons.RESPONSE, zza(zza.zzgd()));
                    jSONObject2.put(SNSInterface.SUCCESS, true);
                    return jSONObject2;
                }
                jSONObject2.put(Cons.RESPONSE, new JSONObject().put("http_request_id", obj));
                jSONObject2.put(SNSInterface.SUCCESS, false);
                jSONObject2.put(RequestKey.REASON, zza.getReason());
                return jSONObject2;
            } catch (Exception e) {
                try {
                    jSONObject2.put(Cons.RESPONSE, new JSONObject().put("http_request_id", obj));
                    jSONObject2.put(SNSInterface.SUCCESS, false);
                    jSONObject2.put(RequestKey.REASON, e.toString());
                    return jSONObject2;
            ...
            try {
                return new JSONObject().put(SNSInterface.SUCCESS, false);
