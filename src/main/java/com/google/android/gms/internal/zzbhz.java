...
public interface zzbhz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbhz {

        private static class zza implements zzbhz {
        ...
        public static zzbhz zzfq(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbhz)) ? new zza(iBinder) : (zzbhz) queryLocalInterface;
        }
