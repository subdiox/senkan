...
public class zzqq extends WebViewClient {
    ...
    private static boolean zzi(Uri uri) {
        ...
        return Endpoint.SCHEME_HTTP.equalsIgnoreCase(scheme) || "https".equalsIgnoreCase(scheme);
    }
    ...
    public void zza(zzdt com_google_android_gms_internal_zzdt, zzh com_google_android_gms_ads_internal_overlay_zzh, zzht com_google_android_gms_internal_zzht, zzq com_google_android_gms_ads_internal_overlay_zzq, boolean z, zzhz com_google_android_gms_internal_zzhz, @Nullable zzib com_google_android_gms_internal_zzib, com.google.android.gms.ads.internal.zze com_google_android_gms_ads_internal_zze, zzkp com_google_android_gms_internal_zzkp, @Nullable zzop com_google_android_gms_internal_zzop) {
