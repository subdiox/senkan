...
import com.kayac.lobi.libnakamap.net.APIDef.PostGroupVisibility.RequestKey;
    ...
    public static final class zza {
        ...
        private void zzt(Context context) {
            ...
            if (registerReceiver != null) {
                ...
                this.zzUr = (double) (((float) registerReceiver.getIntExtra(RequestKey.LEVEL, -1)) / ((float) registerReceiver.getIntExtra("scale", -1)));
