...
public final class WalletFragmentStyle extends zza {
    ...
    private static long zza(TypedValue typedValue) {
        switch (typedValue.type) {
            case 5:
                return zzx(128, typedValue.data);
            case 16:
    ...
    public void zzbO(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(this.zzbQn <= 0 ? R.style.WalletFragmentDefaultStyle : this.zzbQn, R.styleable.WalletFragmentStyle);
