    ...
    protected void zzio() {
        if (!this.zzOT.isEmpty()) {
            ...
            while (true) {
                ...
                ArrayList stringArrayList = zzm.getStringArrayList(IabHelper.RESPONSE_INAPP_ITEM_LIST);
                ArrayList stringArrayList2 = zzm.getStringArrayList(IabHelper.RESPONSE_INAPP_PURCHASE_DATA_LIST);
                ArrayList stringArrayList3 = zzm.getStringArrayList(IabHelper.RESPONSE_INAPP_SIGNATURE_LIST);
                String string = zzm.getString(IabHelper.INAPP_CONTINUATION_TOKEN);
